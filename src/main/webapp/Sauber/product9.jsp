...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/kick-sauber/alfa-romeo-f1-racing-2023-valterri-bottas-driver-cap_ss4_p-13371921+u-15ds489wz1hxnxgal3qo+v-3fd9a72e35024d7c9dd80c79246138cb.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Alfa Romeo F1 Racing 2023 Valterri Bottas Driver Cap</h1>
            <p>
            ...
            <p class="product-price">价格: 326元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Alfa Romeo F1 Racing 2023 Valterri Bottas Driver Cap">
                <input type="hidden" name="dj" value="326">
