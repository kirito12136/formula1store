...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/kick-sauber/alfa-romeo-f1-hoodie_ss4_p-13337189+u-fc98f9yqjwxup3w33mz0+v-1b72d21ed55b4a7581a0ec8a3d1aabd4.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Alfa Romeo F1 Hoodie</h1>
            <p>
            ...
            <p class="product-price">价格: 430元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Alfa Romeo F1 Hoodie">
                <input type="hidden" name="dj" value="430">
