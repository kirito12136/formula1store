...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/kick-sauber/kick-sauber-f1-2024-team-polo_ss5_p-201098807+pv-1+u-srtbdwn6p1tdaggdkacj+v-ddauv4t8qxjminozn53n.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Kick Sauber F1 2024 Team Polo</h1>
            <p>
            ...
            <p class="product-price">价格: 715元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Kick Sauber F1 2024 Team Polo">
                <input type="hidden" name="dj" value="715">
