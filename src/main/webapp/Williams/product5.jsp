...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/williams-racing/williams-racing-keyring_ss5_p-201144585+pv-1+u-7pbpseatjhd4cbeatxdj+v-zdizzrsjhbwqntpwoshv.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Williams Racing Keyring</h1>
            <p>
            ...
            <p class="product-price">价格: 129元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Williams Racing Keyring">
                <input type="hidden" name="dj" value="129">
