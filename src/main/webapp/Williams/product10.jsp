...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/williams-racing/williams-racing-puma-core-logo-t-shirt-blue_ss5_p-201144581+pv-1+u-nyerttlyzda5xemkzflt+v-javrmltscwehjwjn1lvy.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Williams Racing Puma Core Logo T-Shirt - Blue</h1>
            <p>
            ...
            <p class="product-price">价格: 304元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Williams Racing Puma Core Logo T-Shirt - Blue">
                <input type="hidden" name="dj" value="304">
