...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/williams-racing/williams-racing-2024-team-polo-navy_ss5_p-201144570+pv-1+u-9brgaj5focdolggqprub+v-qhjdnzli0fwzd0jftah5.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Williams Racing 2024 Team Polo - Navy</h1>
            <p>
            ...
            <p class="product-price">价格: 654元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Williams Racing 2024 Team Polo - Navy">
                <input type="hidden" name="dj" value="654">
