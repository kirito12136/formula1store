...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/williams-racing/williams-racing-2024-1/4-zip-midlayer_ss5_p-201144568+pv-1+u-rvitsjs7pqbqtsvuislo+v-bmijrpccr2in9c4pnbv0.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Williams Racing 2024 1/4 Zip Midlayer</h1>
            <p>
            ...
            <p class="product-price">价格: 1013元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Williams Racing 2024 1/4 Zip Midlayer">
                <input type="hidden" name="dj" value="1013">
