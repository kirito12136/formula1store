...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/red-bull-racing/red-bull-racing-2024-team-full-zip-hoodie_ss5_p-201084093+pv-1+u-yehdqqmyz8kbjezfagke+v-xub7j7lzgkhakxdpk3dh.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Red Bull Racing 2024 Team Full Zip Hoodie</h1>
            <p>
            ...
            <p class="product-price">价格: 727.2元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Red Bull Racing 2024 Team Full Zip Hoodie">
                <input type="hidden" name="dj" value="727.2">
