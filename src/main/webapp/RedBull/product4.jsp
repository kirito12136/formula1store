...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/red-bull-racing/red-bull-racing-2024-new-era-9forty-special-edition-miami-gp-cap-unisex_ss5_p-201099734+pv-1+u-jkebzzuux4i4cien2bl8+v-etxeonu5nen54bpt4oh6.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Red Bull Racing 2024 New Era 9FORTY Special Edition Miami GP Cap - Unisex</h1>
            <p>
            ...
            <p class="product-price">价格: 346元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Red Bull Racing 2024 New Era 9FORTY Special Edition Miami GP Cap - Unisex">
                <input type="hidden" name="dj" value="346">
