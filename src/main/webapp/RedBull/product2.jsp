...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/red-bull-racing/red-bull-racing-2024-team-set-up-t-shirt_ss5_p-201084100+pv-1+u-hpvemdztorwx9uhncv3g+v-klmb6og18kmg8zxpw54s.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Red Bull Racing 2024 Team Set Up T-Shirt</h1>
            <p>
            ...
            <p class="product-price">价格: 400元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Red Bull Racing 2024 Team Set Up T-Shirt">
                <input type="hidden" name="dj" value="400">
