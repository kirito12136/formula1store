...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/red-bull-racing/red-bull-racing-2024-sergio-perez-team-polo_ss5_p-201084172+pv-1+u-f7tu749kzksjqqgj6xti+v-41oawdgi1v8m9zrazriv.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Red Bull Racing 2024 Sergio Perez Team Polo</h1>
            <p>
            ...
            <p class="product-price">价格: 682元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Red Bull Racing 2024 Sergio Perez Team Polo">
                <input type="hidden" name="dj" value="682">
