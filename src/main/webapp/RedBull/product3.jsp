...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/red-bull-racing/red-bull-racing-2024-team-water-resistant-jacket-unisex_ss5_p-201084105+pv-1+u-ouoqbigk2gkjfhfocwwh+v-ovglihsrnuxct4xvjsbf.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Red Bull Racing 2024 Team Water Resistant Jacket - Unisex</h1>
            <p>
            ...
            <p class="product-price">价格: 1017.6元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Red Bull Racing 2024 Team Water Resistant Jacket - Unisex">
                <input type="hidden" name="dj" value="1017.6">
