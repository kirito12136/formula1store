...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/red-bull-racing/red-bull-racing-2024-new-era-max-verstappen-9forty-cap_ss5_p-201099729+pv-1+u-pxodpbloyz2a0hzrquwj+v-wz6e0s8abmpmnltxhgpk.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Red Bull Racing 2024 New Era Max Verstappen 9FORTY Cap</h1>
            <p>
            ...
            <p class="product-price">价格: 305.6元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Red Bull Racing 2024 New Era Max Verstappen 9FORTY Cap">
                <input type="hidden" name="dj" value="305.6">
