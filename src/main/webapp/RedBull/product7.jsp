...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/red-bull-racing/red-bull-racing-new-era-seasonal-e-frame-trucker-cap_ss5_p-201099700+pv-1+u-arkpijsqudbhcvvbgnhd+v-qewvdju9bm87iuijvalw.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Red Bull Racing New Era Seasonal E-Frame Trucker Cap</h1>
            <p>
            ...
            <p class="product-price">价格: 262.4元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Red Bull Racing New Era Seasonal E-Frame Trucker Cap">
                <input type="hidden" name="dj" value="262.4">
