...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/red-bull-racing/red-bull-racing-2024-team-polo_ss5_p-201084097+pv-1+u-wjdzdp0be50s2xmuzr4w+v-0co0c1hppou2tlswptdu.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Red Bull Racing 2024 Team Polo</h1>
            <p>
            ...
            <p class="product-price">价格: 508.8元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Red Bull Racing 2024 Team Polo">
                <input type="hidden" name="dj" value="508.8">
