...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/alpine/alpine-f1-team-2024-t-shirt-white_ss5_p-200837885+pv-1+u-pdccjjyn76dyxiuqpcot+v-5s5prckpgg8brloxr1yf.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Alpine F1 Team 2024 T-Shirt - White</h1>
            <p>
            ...
            <p class="product-price">价格: 406元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Alpine F1 Team 2024 T-Shirt - White">
                <input type="hidden" name="dj" value="406">
