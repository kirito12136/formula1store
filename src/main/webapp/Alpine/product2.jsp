...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/alpine/alpine-f1-team-pierre-gasly-2024-driver-t-shirt_ss5_p-200837887+pv-1+u-wut5f8x6v6xtjfs1bxwt+v-g4en8csldayshdhe5ozw.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Alpine F1 Team Pierre Gasly 2024 Driver T-Shirt</h1>
            <p>
            ...
            <p class="product-price">价格: 586元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Alpine F1 Team Pierre Gasly 2024 Driver T-Shirt">
                <input type="hidden" name="dj" value="586">
