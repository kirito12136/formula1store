...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/alpine/alpine-f1-team-supporter-t-shirt-blue_ss5_p-200837891+pv-1+u-dx5vpv1nbhvg0jtbr1wg+v-gxw8biamegnwmwyvrqq0.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Alpine F1 Team Supporter T-Shirt - Blue</h1>
            <p>
            ...
            <p class="product-price">价格: 288元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Alpine F1 Team Supporter T-Shirt - Blue">
                <input type="hidden" name="dj" value="288">
