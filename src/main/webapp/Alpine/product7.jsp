...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/alpine/alpine-f1-team-2024-softshell-jacket_ss5_p-200837890+pv-1+u-fqhbbduapqktaurbcosf+v-i3kaiujyxnddw48xrfkh.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Alpine F1 Team 2024 Softshell Jacket</h1>
            <p>
            ...
            <p class="product-price">价格: 960元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Alpine F1 Team 2024 Softshell Jacket">
                <input type="hidden" name="dj" value="960">
