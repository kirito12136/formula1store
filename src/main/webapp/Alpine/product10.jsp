...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/alpine/bwt-alpine-f1-team-2022-polo-shirt-blue_ss4_p-12097639+u-1sp1cacn3tx9317phkr+v-378e191c48af46769352a3aca47b626d.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>BWT Alpine F1 Team 2022 Polo Shirt - Blue</h1>
            <p>
            ...
            <p class="product-price">价格: 323元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="BWT Alpine F1 Team 2022 Polo Shirt - Blue">
                <input type="hidden" name="dj" value="323">
