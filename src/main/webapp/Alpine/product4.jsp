...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/alpine/bwt-alpine-f1-team-2023-a523-pierre-gasly-1:43-model_ss5_p-201150637+pv-1+u-e4hz8xza6upsnygtaqwj+v-vu9agyktowfxcwk1ltch.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>BWT Alpine F1 Team 2023 A523 Pierre Gasly 1:43 model</h1>
            <p>
            ...
            <p>
                ...
                <input type="hidden" name="spm" value="BWT Alpine F1 Team 2023 A523 Pierre Gasly model">
