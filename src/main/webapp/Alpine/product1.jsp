...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/alpine/alpine-f1-team-2024-new-era-9fifty-pre-curve-special-edition-monaco-gp-cap_ss5_p-201099744+pv-1+u-ig0ksndhk09brimcdqys+v-gcwmdxdgten8qiih7gj6.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Alpine F1 Team 2024 New Era 9FIFTY Pre Curve Special Edition Monaco GP Cap</h1>
            <p>
            ...
            <p class="product-price">价格: 361元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Alpine F1 Team 2024 New Era 9FIFTY Pre Curve Special Edition Monaco GP Cap">
                <input type="hidden" name="dj" value="361">
