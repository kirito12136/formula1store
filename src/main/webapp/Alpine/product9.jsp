...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/alpine/bwt-alpine-f1-team-2023-esteban-ocon-1:5-sparks-model-helmet_ss5_p-14420753+pv-1+u-jgofl7ji6jqofkbzcfov+v-vwfmxl8y7kycbcspw0vw.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>BWT Alpine F1 Team 2023 Esteban Ocon 1:5 Sparks Model Helmet</h1>
            <p>
            ...
            <p class="product-price">价格: 280元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="BWT Alpine F1 Team 2023 Esteban Ocon Sparks Model Helmet">
                <input type="hidden" name="dj" value="280">
