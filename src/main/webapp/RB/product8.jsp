...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/rb/scuderia-alphatauri-at04-no21-2023-nyck-de-vries-1:64-model_ss5_p-14420749+pv-1+u-kpuuf9beok9rf5ggwpl5+v-njwpvntxcyxtem8cnm2k.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Scuderia AlphaTauri AT04 No.21 2023 Nyck de Vries 1:64 Model</h1>
            <p>
            ...
            <p class="product-price">价格: 124元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Scuderia AlphaTauri AT04 No.21 2023 Nyck de Vries Model">
                <input type="hidden" name="dj" value="124">
