...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/rb/scuderia-alphatauri-las-vegas-gp-special-edition-t-shirt_ss5_p-13371458+pv-1+u-7d14wnhispuk8pmcbgry+v-niyzqxdiiysyp0o1fqwn.png?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Scuderia AlphaTauri Las Vegas GP Special Edition T-Shirt</h1>
            <p>
            ...
            <p class="product-price">价格: 297元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Scuderia AlphaTauri Las Vegas GP Special Edition T-Shirt">
                <input type="hidden" name="dj" value="297">
