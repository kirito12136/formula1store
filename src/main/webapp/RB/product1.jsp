...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/rb/scuderia-alphatauri-las-vegas-gp-special-edition-hoodie_ss5_p-14420972+pv-1+u-q3b4ofnul86ax4ro1hwv+v-ithhvzzj605zhbkj3ebg.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Scuderia AlphaTauri Las Vegas GP Special Edition Hoodie</h1>
            <p>
            ...
            <p class="product-price">价格: 518元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Scuderia AlphaTauri Las Vegas GP Special Edition Hoodie">
                <input type="hidden" name="dj" value="518">
