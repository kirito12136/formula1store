...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/rb/scuderia-alphatauri-at03-no21-2023-nyck-de-vries-1:18-model_ss5_p-200370411+pv-1+u-bby3s1rqfirrpwhd2u9a+v-mjs3m6qh9mtkh9egjimx.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Scuderia AlphaTauri AT03 No.21 2023 - Nyck de Vries 1:18 Model</h1>
            <p>
            ...
            <p class="product-price">价格: 1749元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Scuderia AlphaTauri AT03 No.21 2023 - Nyck de Vries Model">
                <input type="hidden" name="dj" value="1749">
