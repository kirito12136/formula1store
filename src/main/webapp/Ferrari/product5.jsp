...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/scuderia-ferrari/scuderia-ferrari-2024-team-crew-neck-sweat_ss5_p-201131557+pv-1+u-4harbcachrloqzb4p6hf+v-zifmmjlii64ya5wboesy.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Scuderia Ferrari 2024 Team Crew Neck Sweat</h1>
            <p>
            ...
            <p class="product-price">价格: 942元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Scuderia Ferrari 2024 Team Crew Neck Sweat">
                <input type="hidden" name="dj" value="942">
