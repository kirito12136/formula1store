...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/scuderia-ferrari/scuderia-ferrari-puma-special-edition-miami-t-shirt_ss5_p-201130742+pv-1+u-ogswsggyuhh7kjzswpm3+v-n7zxw8ukc1r5v5ybffnn.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Scuderia Ferrari Puma Special Edition Miami T-Shirt</h1>
            <p>
            ...
            <p class="product-price">价格: 426元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Scuderia Ferrari Puma Special Edition Miami T-Shirt">
                <input type="hidden" name="dj" value="426">
