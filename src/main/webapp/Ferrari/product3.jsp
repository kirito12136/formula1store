...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/scuderia-ferrari/scuderia-ferrari-2024-team-polo_ss5_p-201131528+pv-1+u-w9sr46e609d9pnt8u86c+v-zjpzrx2u10ukgqhyvfxu.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Scuderia Ferrari 2024 Team Polo</h1>
            <p>
            ...
            <p class="product-price">价格: 733元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Scuderia Ferrari 2024 Team Polo">
                <input type="hidden" name="dj" value="733">
