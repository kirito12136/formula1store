...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/scuderia-ferrari/scuderia-ferrari-race-big-shield-tonal-t-shirt-by-puma-black_ss5_p-201130709+pv-1+u-zr7o5llgwdseext4q5pi+v-mxestmbitvkz7pkmkp3u.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Scuderia Ferrari Race Big Shield Tonal T-Shirt by Puma - Black</h1>
            <p>
            ...
            <p class="product-price">价格: 417元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Scuderia Ferrari Race Big Shield Tonal T-Shirt by Puma - Black">
                <input type="hidden" name="dj" value="417">
