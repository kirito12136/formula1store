...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/scuderia-ferrari/scuderia-ferrari-race-graphic-sweatshirt-by-puma_ss4_p-13345734+u-2vsvysj0idabfvikoedh+v-414a7088b0434fbf812770ecc9bf7092.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Scuderia Ferrari Race Graphic Sweatshirt by Puma</h1>
            <p>
            ...
            <p class="product-price">价格: 471元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Scuderia Ferrari Race Graphic Sweatshirt by Puma">
                <input type="hidden" name="dj" value="471">
