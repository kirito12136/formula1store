...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/scuderia-ferrari/scuderia-ferrari-kart-cat-mid-trainers-by-puma_ss5_p-201130735+pv-1+u-6kejawb1dzupbntjntyg+v-0lzhzhkrjhml7s4chvf0.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Scuderia Ferrari Kart Cat Mid Trainers by Puma</h1>
            <p>
            ...
            <p class="product-price">价格: 516元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Scuderia Ferrari Kart Cat Mid Trainers by Puma">
                <input type="hidden" name="dj" value="516">
