...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/aston-martin/aston-martin-aramco-f1-2024-team-driver-hoodie_ss5_p-200838313+pv-1+u-jqcrgxpgi6vrftk2vfr0+v-6xel5z5tet4h9ksg7fw8.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Aston Martin Aramco F1 2024 Team Driver Hoodie</h1>
            <p>
            ...
            <p class="product-price">价格: 1032元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Aston Martin Aramco F1 2024 Team Driver Hoodie">
                <input type="hidden" name="dj" value="1032">
