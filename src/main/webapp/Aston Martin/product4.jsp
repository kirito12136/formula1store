...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/aston-martin/aston-martin-aramco-f1-2024-team-hybrid-jacket_ss5_p-200838289+pv-1+u-p78fwahxtnvbsqnycj0e+v-xvqm1oqm0a3pyychmxqg.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Aston Martin Aramco F1 2024 Team Hybrid Jacket</h1>
            <p>
            ...
            <p class="product-price">价格: 1593元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Aston Martin Aramco F1 2024 Team Hybrid Jacket">
                <input type="hidden" name="dj" value="1593">
