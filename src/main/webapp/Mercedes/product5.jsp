...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/mercedes-amg-petronas-f1-team/mercedes-amg-petronas-f1-lewis-hamilton-44-hoodie-black_ss5_p-201163869+pv-1+u-ik0ixgjtlyq4gier34fe+v-vwm56u7ypkwhsv7zpwd5.png?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Mercedes AMG Petronas F1 Lewis Hamilton 44 Hoodie - Black</h1>
            <p>
            ...
            <p class="product-price">价格: 818元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Mercedes AMG Petronas F1 Lewis Hamilton 44 Hoodie - Black">
                <input type="hidden" name="dj" value="818">
