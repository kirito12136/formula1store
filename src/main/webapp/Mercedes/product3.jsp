...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/mercedes-amg-petronas-f1-team/mercedes-amg-petronas-f1-2024-team-driver-t-shirt-white_ss5_p-201163832+pv-1+u-prbmfkus8r43mzx1teoy+v-z6wtgoihj4mombchm86q.jpg?_hv=2&w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Mercedes AMG Petronas F1 2024 Team Driver T-Shirt - White</h1>
            <p>
            ...
            <p class="product-price">价格: 564元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Mercedes AMG Petronas F1 2024 Team Driver T-Shirt - White">
                <input type="hidden" name="dj" value="564">
