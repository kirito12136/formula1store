...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/mercedes-amg-petronas-f1-team/mercedes-amg-petronas-f1-2023-w14-lewis-hamilton-1:43-model-with-figure_ss5_p-201150676+pv-1+u-zheno3n0bzr2xpqwvqfq+v-6lw2cc9ljntfr0tgvar4.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Mercedes AMG Petronas F1 2023 W14 - Lewis Hamilton</h1>
            <p>
            ...
            <p class="product-price">价格: 160元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Mercedes AMG Petronas F1 2023 W14 - Lewis Hamilton">
                <input type="hidden" name="dj" value="160">
