...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/mercedes-amg-petronas-f1-team/mercedes-amg-petronas-f1-logo-cap-black_ss5_p-201163881+pv-1+u-cbrzenjnqoalptj9gwnu+v-sw6z0udntzhp5s6kh3cd.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Mercedes AMG Petronas F1 Logo Cap - Black</h1>
            <p>
            ...
            <p class="product-price">价格: 255元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Mercedes AMG Petronas F1 Logo Cap - Black">
                <input type="hidden" name="dj" value="255">
