...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/mercedes-amg-petronas-f1-team/mercedes-amg-petronas-f1-2024-team-polo-black_ss5_p-201163828+pv-1+u-vyhi3j6yryhbdnx2p7hb+v-dhiybskhrgxg5ve3xfm5.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Mercedes AMG Petronas F1 2024 Team Polo - Black</h1>
            <p>
            ...
            <p class="product-price">价格: 691元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Mercedes AMG Petronas F1 2024 Team Polo - Black">
                <input type="hidden" name="dj" value="691">
