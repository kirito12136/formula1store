...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/mercedes-amg-petronas-f1-team/mercedes-amg-petronas-f1-lewis-hamilton-44-polo_ss4_p-13368414+u-7jdx2qnvk4cx4no0fj30+v-ecf930dea6694837ab5086ba22f29c51.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Mercedes AMG Petronas F1 Lewis Hamilton 44 Polo</h1>
            <p>
            ...
            <p class="product-price">价格: 226元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Mercedes AMG Petronas F1 Lewis Hamilton 44 Polo">
                <input type="hidden" name="dj" value="226">
