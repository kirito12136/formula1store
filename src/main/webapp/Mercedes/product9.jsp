...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/mercedes-amg-petronas-f1-team/mercedes-amg-petronas-f1-lewis-hamilton-44-t-shirt-black_ss5_p-201163860+pv-1+u-ievxqe6mo8aew7itjycd+v-a4a605hicfgyaxycabwm.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Mercedes AMG Petronas F1 Lewis Hamilton 44 T-Shirt - Black</h1>
            <p>
            ...
            <p class="product-price">价格: 391元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Mercedes AMG Petronas F1 Lewis Hamilton 44 T-Shirt - Black">
                <input type="hidden" name="dj" value="391">
