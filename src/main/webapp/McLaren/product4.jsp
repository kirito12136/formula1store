...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/mclaren-f1-team/mclaren-new-era-seasonal-9forty-pastel-pink_ss5_p-201099696+pv-1+u-wrhpbuzrnvu42mh33nlo+v-mk4hmm4fd4dcimzdtulb.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>McLaren New Era Seasonal 9FORTY- Pastel Pink</h1>
            <p>
            ...
            <p class="product-price">价格: 263元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="McLaren New Era Seasonal 9FORTY- Pastel Pink">
                <input type="hidden" name="dj" value="263">
