...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/mclaren-f1-team/mclaren-essential-logo-hoodie-black-unisex_ss5_p-201088312+pv-1+u-lubdxftkw16kfqtysf5y+v-vcu5pdwynnlwapln0ugi.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>McLaren Essential Logo Hoodie - Black - Unisex</h1>
            <p>
            ...
            <p class="product-price">价格: 589元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="McLaren Essential Logo Hoodie - Black - Unisex">
                <input type="hidden" name="dj" value="589">
