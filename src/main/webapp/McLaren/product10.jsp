...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/mclaren-f1-team/mclaren-2024-team-set-up-t-shirt-phantom_ss5_p-201084324+pv-1+u-pqtyowjlsypsphvqi06d+v-hpxxjdwhrceqo3tcnypx.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>McLaren 2024 Team Set Up T-Shirt - Phantom</h1>
            <p>
            ...
            <p class="product-price">价格: 498元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="McLaren 2024 Team Set Up T-Shirt - Phantom">
                <input type="hidden" name="dj" value="498">
