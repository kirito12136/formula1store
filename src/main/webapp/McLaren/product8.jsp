...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/mclaren-f1-team/mclaren-new-era-heritage-patch-trucker-cap_ss4_p-13368478+u-r2z9rb9o8bmzxbayksx0+v-73d929517280467990c73d0befd090e7.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>McLaren New Era Heritage Patch Trucker Cap</h1>
            <p>
            ...
            <p class="product-price">价格: 317元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="McLaren New Era Heritage Patch Trucker Cap">
                <input type="hidden" name="dj" value="317">
