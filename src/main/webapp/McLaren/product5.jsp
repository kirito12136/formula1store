...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/mclaren-f1-team/mclaren-2023-lando-norris-1:5-sparks-model-helmet_ss5_p-14420766+pv-1+u-rwg9jq0lktv9d5snjl43+v-lygq8nidx6sgnmc6ksrg.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>McLaren 2023 Lando Norris 1:5 Sparks Model Helmet</h1>
            <p>
            ...
            <p class="product-price">价格: 344元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="McLaren 2023 Lando Norris Sparks Model Helmet">
                <input type="hidden" name="dj" value="344">
