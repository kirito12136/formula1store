...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/kick-sauber/alfa-romeo-sauber-f1-team-stake-c43-no24-2023-zhou-guanyu-1:18-model_ss5_p-200370400+pv-1+u-zf0zzbz28bjwv18mklfu+v-8qht3wzrdc7zhlfw1yqe.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Alfa Romeo Sauber F1 Team Stake C43 No.24 2023 - Zhou Guanyu 1:18 Model</h1>
            <p>
            ...
            <p class="product-price">价格: 1720元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Alfa Romeo Sauber F1 Team Stake C43 No.24 2023 - Zhou Guanyu Model">
                <input type="hidden" name="dj" value="1720">
