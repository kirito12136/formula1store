...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/haas-f1-team/haas-f1-2023-team-new-era-kevin-magnussen-9fifty-pre-curve-cap_ss5_p-201118789+pv-1+u-unnkaf9zibbforhmkkqo+v-vci8pndbeb1ofutkprh4.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Haas F1 2023 Team New Era Kevin Magnussen 9FIFTY Pre Curve Cap</h1>
            <p>
            ...
            <p class="product-price">价格: 378元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Haas F1 2023 Team New Era Kevin Magnussen 9FIFTY Pre Curve Cap">
                <input type="hidden" name="dj" value="378">
