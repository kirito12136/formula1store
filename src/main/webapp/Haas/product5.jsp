...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/haas-f1-team/haas-f1-2024-team-9forty-cap_ss5_p-201118788+pv-1+u-thofaafnbafgszqdthe3+v-9t98kikkfm1zbvlmq0lc.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Haas F1 2024 Team 9FORTY Cap</h1>
            <p>
            ...
            <p class="product-price">价格: 276元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Haas F1 2024 Team 9FORTY Cap">
                <input type="hidden" name="dj" value="276">
