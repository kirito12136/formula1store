...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/haas-f1-team/haas-f1-f1-team-united-states-grand-prix-2023-large-poster_ss5_p-200868037+pv-1+u-r7hy8ojhlsbhpgs2htp4+v-ffqibvjvpyzomlrtumyx.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Haas F1 F1 Team - United States Grand Prix 2023 Large Poster</h1>
            <p>
            ...
            <p class="product-price">价格: 449元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Haas F1 F1 Team - United States Grand Prix 2023 Large Poster">
                <input type="hidden" name="dj" value="449">
