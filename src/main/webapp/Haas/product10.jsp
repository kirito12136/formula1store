...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/haas-f1-team/haas-f1-2024-team-bobble-beanie_ss5_p-201118787+pv-1+u-a2bujtgscirai1uqinyz+v-vlemn5trbjbn60ladx9r.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Haas F1 2024 Team Bobble Beanie</h1>
            <p>
            ...
            <p class="product-price">价格: 258元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Haas F1 2024 Team Bobble Beanie">
                <input type="hidden" name="dj" value="258">
