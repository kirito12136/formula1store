...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/haas-f1-team/haas-f1-miami-grand-prix-2024-poster_ss5_p-201547035+pv-1+u-6xnzfpwfb2yxzlzddev1+v-fmtasxacgy8ixukmt668.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Haas F1 Miami Grand Prix 2024 Poster</h1>
            <p>
            ...
            <p class="product-price">价格: 599元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Haas F1 Miami Grand Prix 2024 Poster">
                <input type="hidden" name="dj" value="599">
