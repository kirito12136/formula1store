...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/haas-f1-team/haas-f1-moneygram-2024-team-polo-womens_ss5_p-201110607+pv-1+u-hfdatss0novafz9sggwt+v-s6puwmh6ygi6jcvjqw5c.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Haas F1 Moneygram 2024 Team Polo - Womens</h1>
            <p>
            ...
            <p class="product-price">价格: 663元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Haas F1 Moneygram 2024 Team Polo - Womens">
                <input type="hidden" name="dj" value="663">
