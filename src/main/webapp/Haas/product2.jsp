...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/haas-f1-team/haas-f1-moneygram-2024-team-zip-sweater_ss5_p-201118803+pv-1+u-b5t87waep6dxeyjndhpi+v-iuzxyu4eaenuyuzofdov.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Haas F1 Moneygram 2024 Team Zip Sweater</h1>
            <p>
            ...
            <p class="product-price">价格: 656元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Haas F1 Moneygram 2024 Team Zip Sweater">
                <input type="hidden" name="dj" value="656">
