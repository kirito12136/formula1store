...
<div class="container">
    <div class="product-image">
        <img src="//images.footballfanatics.com/haas-f1-team/haas-f1-moneygram-2024-team-t-shirt_ss5_p-201110605+pv-1+u-tztk9c12cb8uwpqaqhst+v-2fxl0lq4gvraiqva8rdg.jpg?_hv=2&amp;w=900"
             alt="商品图片">
    </div>
    <form id="form1" name="form1" method="post" action="../car.jsp">
        <div class="product-details">
            <h1>Haas F1 Moneygram 2024 Team T-Shirt</h1>
            <p>
            ...
            <p class="product-price">价格: 380元</p>
            <p>
                数量:
                <label for="sl"></label>
                ...
                <input type="hidden" name="spm" value="Haas F1 Moneygram 2024 Team T-Shirt">
                <input type="hidden" name="dj" value="380">
